...
public class PgpHelper {
	...
	@SuppressWarnings("unchecked")
	public static boolean decrypt(String cipherTextFile, String plainTextFile, String pubKeyFile, char[] passwd)
	{

		try
		{
			LUtil.println("JSVR decrypt pubKeyFile : ", pubKeyFile);
			FileInputStream pubKeyIs = new FileInputStream(pubKeyFile);
			LUtil.println("JSVR decrypt cipherTextFile : ", cipherTextFile);
			FileInputStream cipheredFileIs = new FileInputStream(cipherTextFile);
			LUtil.println("JSVR decrypt plainTextFile : ", plainTextFile);
			FileOutputStream plainFileIs = new FileOutputStream(plainTextFile);

			LUtil.println("JSVR decrypt plainTextFile : ");
			PgpHelper.getInstance().decryptFile(cipheredFileIs, plainFileIs, pubKeyIs, passwd);
		...
		{
			System.out.print(pex.getMessage());
			LUtil.println("JSVR decrypt PGPException", pex.getMessage());
			return false;
		}
		catch (NoSuchProviderException nspex)
		{
			System.out.print(nspex.getMessage());
			LUtil.println("JSVR decrypt NoSuchProviderException", nspex.getMessage());
			return false;
		}
		catch (IOException ioex)
		{
			System.out.print(ioex.getMessage());
			LUtil.println("JSVR decrypt IOException", ioex.getMessage());
			return false;
		}
		catch (Exception ex)
		{
			System.out.print("Errro : " + ex.getMessage());
			LUtil.println("JSVR decrypt Exception", ex.getMessage());
			return false;
		}
	}
	...
	@SuppressWarnings("unchecked")
	public static boolean encrypt(String plainTextFile, String cipherTextFile, String pubKeyFile)
	{
		...
		{
			System.out.print(pex.getMessage());
			LUtil.println("JSVR encrypt PGPException", pex.getMessage());
			return false;
		}
		catch (NoSuchProviderException nspex)
		{
			System.out.print(nspex.getMessage());
			LUtil.println("JSVR encrypt NoSuchProviderException", nspex.getMessage());
			return false;
		}
		catch (IOException ioex)
		{
			System.out.print(ioex.getMessage());
			LUtil.println("JSVR encrypt IOException", ioex.getMessage());
			return false;
		}
		catch (Exception ex)
		{
			System.out.print("Errro : " + ex.getMessage());
			LUtil.println("JSVR encrypt Exception", ex.getMessage());
			return false;
		}
	}
